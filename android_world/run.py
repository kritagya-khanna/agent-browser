...
def _get_agent(
  ...
  # Gemini 2.5 Pro (service account auth via Vertex AI).
  elif _AGENT_NAME.value == 'm3a_gemini25':
    agent = m3a.M3A(env, infer.Gemini25ProWrapper())
  elif _AGENT_NAME.value == 't3a_gemini25':
    agent = t3a.T3A(env, infer.Gemini25ProWrapper())
  # GPT.
